...
const DATA = {
  zh: {
    ...
    tableware: {
      col1: '一次性塑膠餐具', col2: 'PGT 環保餐具',
      rows: [
        { category: '生物分解性', bad: '數百年不分解',         good: '堆肥環境 180 天分解' },
        { category: '耐熱溫度',   bad: '約 60–80°C（易變形）', good: '耐熱達 120°C' },
        { category: '微波安全',   bad: '不可微波（釋放毒素）', good: '可安全微波使用' },
        { category: '食品安全',   bad: '可能含塑化劑',         good: 'FDA 食品接觸認證' },
        { category: '外觀質感',   bad: '廉價塑膠質感',         good: '植物纖維質感，品牌感強' },
        { category: '碳足跡',     bad: '石化原料，高碳排',     good: '植物基材料，低碳排' },
  ...
  en: {
    ...
    tableware: {
      col1: 'Single-use Plastic Tableware', col2: 'PGT Eco Tableware',
      rows: [
        { category: 'Biodegradability',   bad: 'Hundreds of years to degrade',    good: 'Compost-degrades in 180 days' },
        { category: 'Heat Resistance',    bad: '60–80°C (deforms easily)',         good: 'Resistant up to 120°C' },
        { category: 'Microwave Safety',   bad: 'Not microwave-safe (leaches)',     good: 'Fully microwave-safe' },
        { category: 'Food Safety',        bad: 'May contain plasticizers',         good: 'FDA food-contact certified' },
        { category: 'Appearance',         bad: 'Cheap plastic aesthetic',          good: 'Plant-fiber feel, premium look' },
        { category: 'Carbon Footprint',   bad: 'Petrochemical-based, high carbon', good: 'Plant-based, low carbon' },
        { category: 'Toxins',             bad: 'May contain fluorescent agents',   good: 'Non-toxic, zero hazardous' },
